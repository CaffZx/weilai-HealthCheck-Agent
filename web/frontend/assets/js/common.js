...
const CALIBRATION_LABELS = {
  CURRENT_CONFIRMED: '当前仍命中',
  HANDLED_NOT_REPRODUCED: '处理后未复现',
  UNHANDLED_NOT_REPRODUCED: '当前规则不再支持，待复核',
  INSUFFICIENT_OR_SKIPPED: '证据不足，待复核',
  SUPERSEDED: '历史身份已替代',
  NO_BASELINE: '缺少校正基线',
};
function calibrationLabel(value){ return CALIBRATION_LABELS[value] || value || ''; }
